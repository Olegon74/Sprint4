...
public class HomePageConstants {
    public static final By QUESTION_32 = By.id("accordion__heading-0");
    public static final By QUESTION_33 = By.id("accordion__heading-1");
    public static final By ANSWER_32 = By.id("accordion__panel-0");
    public static final By ANSWER_33 = By.id("accordion__panel-1");
